...
Score = 0
awnser1 = int(input("how many letters in the alphabet "))
if awnser1 == 1:
	print("correct")
	score += 1
else:
...
awnser2 = input("what is the offical tree of india")
if awnser2 == "banyan tree":
	print("correct")
	score =+ 1
else:
	print("incorrect")

awnser3 = input("what is the smallest bone in the body")
if awnser3 == "stapes":
	print("correct")
	score =+ 1
else:
...
awnser4 = input("name the hardest substance on earth")
if awnser4 == "diamond":
	print("correct")
	score =+ 1
else:
...
awnser5 = input("name the largest 'Democracy' of the world")
if awnser5 == "india":
	print("correct")
	score =+ 1
else:
